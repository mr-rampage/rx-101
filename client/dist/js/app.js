...
var _cash = require("cash-dom/dist/cash.min");

var _cash2 = _interopRequireDefault(_cash);

var _username3 = require("./username/username.service");
...
(0, _cash2.default)(document).ready(function () {
  ...
  _username4.default.isAvailable();
});

},{"./username/username.component":7,"./username/username.service":8,"./utils/logger":10,"cash-dom/dist/cash.min":2}],6:[function(require,module,exports){
'use strict';
...
function createInvalidComponentObserver(element, isValid) {
  return _rx2.default.Observer.create(function (value) {
...
var componentObserverFactory = Object.freeze({
  createInvalidComponentObserver: createInvalidComponentObserver
});

exports.default = componentObserverFactory;

},{"rx/dist/rx.lite":3}],7:[function(require,module,exports){
"use strict";
...
var _domFactory = require("../utils/dom-factory");

var _domFactory2 = _interopRequireDefault(_domFactory);

var _componentObserver = require("../component/component-observer.factory");

var _componentObserver2 = _interopRequireDefault(_componentObserver);
...
},{"../component/component-observer.factory":6,"../utils/dom-factory":9,"rx/dist/rx.lite":3}],8:[function(require,module,exports){
'use strict';
...
function isAvailable(username) {
  fetch('/api/username/ping').then(function (response) {
    console.log(response);
  });
}

var usernameService = Object.freeze({
...
function createFormComponent(config) {
  var label = (0, _cash2.default)('<label><span>' + (config.prompt || '') + '</span></label>');
  var element = createInput(config);
...
function createInput(config) {
  switch (config.type) {
    ...
    default:
      return (0, _cash2.default)('div');
  };
}

function createTextInput(config) {
  var template = '<input type="' + config.type + '" name="' + config.name + '" value="' + (config.value || '') + '"/>';
  return (0, _cash2.default)(template);
}
...
},{"cash-dom/dist/cash.min":2}],10:[function(require,module,exports){
"use strict";
